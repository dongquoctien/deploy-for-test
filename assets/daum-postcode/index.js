(function () {
  /*VERSION:210409*/ function checkWebviewCustomUA(a) {
  ...
  (window.daum = window.daum || {}),
    (function (a) {
      ...
      for (var d = document.getElementsByTagName('script'), e = 0, f = d.length; f > e; ++e) {
        var g = d[e],
          h = g.src;
  ...
  !(function (a, b, c, d, e) {
    ...
    (a.CONT = {
      ...
      (a.viewUtils = (function () {
        ...
        function n(a, b) {
          if (q.POPUP_MAP[a]) for (var c = q.POPUP_MAP[a], d = 0, e = c.length; e > d; d++) if (b === c[d].ref) return !0;
          return !1;
        }
        function o(a) {
          for (var b in q.POPUP_MAP) if (q.POPUP_MAP.hasOwnProperty(b)) for (var c = q.POPUP_MAP[b], d = 0, e = c.length; e > d; d++) if (a === c[d].ref) return c[d];
          return null;
        }
        function p(a) {
          var b =
    ...
    a.frame = (function () {
      function a(a) {
        ...
        var d = q + '&' + f.getStringByOptions(c, '=', '&'),
          ...
          g = '&' + f.getStringByOptions({ fullpath: r + s }, '=', '&'),
          i =
      ...
      function l(b, c, d, e) {
        ...
        f.document.write(a(d)),
          ...
          j.setReady(
            ...
            function (a, i) {
              if ('reload' === a) {
                if ((b.focus(), f && f.document)) {
                  var k = f.document.getElementById(j.getId('viewerFrame', d.viewerNo));
                  k && k.focus();
                }
              } else
                'search' === a
                  ? d.onSearch !== g.EMPTY_FUNCTION && d.onSearch(i)
                  : 'resize' === a
                  ? d.onResize !== g.EMPTY_FUNCTION && (d.onResize(i), h.adjustLowIE(f, b, c, j.getId('viewerFrame', d.viewerNo), i.width, i.height))
                  : 'done' === a &&
                    d.onComplete !== g.EMPTY_FUNCTION &&
                    setTimeout(function () {
                      d.onComplete(i), d.autoClose && (h.IE11CompatibleBugFix(f), h.remove(e, c), d.onClose !== g.EMPTY_FUNCTION && d.onClose(g.POPUP_CLOSE_STATE.COMPLETE));
                    }, 0);
            },
            d,
          );
      ...
      function n(b, c) {
        var d = b.window;
        d.document.write(a(c)), h.setFrameStyle(d.document.getElementsByTagName('html')[0], d.document.getElementsByTagName('body')[0]), d.document.close();
        try {
          var e = d.document.head || d.document.getElementsByTagName('head')[0];
          if (e) {
            var f = 'Daum Postcode Service',
              i = null,
              k = null,
              l = d.document.getElementsByTagName('title')[0];
            l
              ? (e.removeChild(l), (i = d.document.createElement('title')), (i.innerHTML = f), e.appendChild(i))
          ...
          function (a, d) {
            'done' === a
              ? c.onComplete !== g.EMPTY_FUNCTION &&
                setTimeout(function () {
                  if ((c.onComplete(d), c.autoClose))
                    if (c.onClose !== g.EMPTY_FUNCTION) {
                      var a = h.getPopupMap(b);
                      a && clearInterval(a.data.closeCallbackTimer), b.close(), c.onClose(g.POPUP_CLOSE_STATE.COMPLETE);
                    } else b.close();
                }, 0)
              : 'search' === a && c.onSearch !== g.EMPTY_FUNCTION && c.onSearch(d);
          },
          c,
        );
      }
    ...
    a.themePreprocessor = (function () {
      ...
      function d(a, b) {
        var c = n(a),
          ...
          g = o(d.r, d.g, d.b);
        Math.abs(f.l - g.l) < e &&
          (f.l >= g.l ? ((g.l -= e - Math.abs(f.l - g.l)), (g.l = g.l < 0 ? g.l + 1 : g.l)) : f.l < g.l && ((g.l += e - Math.abs(f.l - g.l)), (g.l = g.l > 1 ? g.l - 1 : g.l)));
        var h = p(g.h, g.s, g.l);
      ...
      function q(a, b, c) {
        return 0 > c && (c += 1), c > 1 && (c -= 1), 1 / 6 > c ? a + 6 * (b - a) * c : 0.5 > c ? b : 2 / 3 > c ? a + (b - a) * (2 / 3 - c) * 6 : a;
      }
      function r(a) {
        var b = {},
          c = !1;
  ...
  !(function (a, b, c, d, e) {
    function f(a, b) {
      ...
      if (b) {
        ...
        d &&
          'string' == typeof d &&
          '' !== m.trim(d) &&
          (c = e === !0 ? m.extend(a, { region_name: encodeURIComponent(d), cq: encodeURIComponent(d), intsh: 'on' }) : m.extend(a, { userQuery: encodeURIComponent(d), cq: encodeURIComponent(d) }));
      }
      return c;
    }
    function g(a, b) {
    ...
    function h(a, b) {
      ...
      if (b) {
        var d = b.popupName;
        d && 'string' == typeof d && '' !== m.trim(d) && (c = m.extend(a, { popupName: d }));
      }
      return c;
    }
    function i(a, b) {
      ...
      if (b) {
        var d = b.autoClose;
        void 0 !== d && null !== d && 'boolean' == typeof d && (c = m.extend(a, { autoClose: d }));
      }
      return c;
    }
    function j(a) {
      var b = ++o.VIEWER_COUNT,
        c = {
          width: n.DEFAULT_WIDTH,
          height: n.DEFAULT_HEIGHT,
          top: 50,
          left: 100,
          onComplete: n.EMPTY_FUNCTION,
          oncomplete: n.EMPTY_FUNCTION,
          onResize: n.EMPTY_FUNCTION,
          onresize: n.EMPTY_FUNCTION,
          onClose: n.EMPTY_FUNCTION,
          onclose: n.EMPTY_FUNCTION,
          onSearch: n.EMPTY_FUNCTION,
          onsearch: n.EMPTY_FUNCTION,
          autoMapping: !0,
          animation: !1,
          shorthand: !0,
      ...
      var d = p.getNormalizeSize(c.width, n.DEFAULT_WIDTH, n.MIN_WIDTH),
        e = p.getNormalizeSize(c.height, n.DEFAULT_HEIGHT, n.MIN_HEIGHT);
      if (
        ((c.width = d.value),
        (c.isFlexibleWidth = d.isFlexible),
        (c.height = e.value),
        (c.isFlexibleHeight = e.isFlexible),
        c.onComplete && 'function' == typeof c.onComplete && c.onComplete !== n.EMPTY_FUNCTION
          ? (c.onComplete = c.onComplete)
          : c.oncomplete && 'function' == typeof c.oncomplete && c.oncomplete !== n.EMPTY_FUNCTION
          ? (c.onComplete = c.oncomplete)
          : ((c.onComplete = n.EMPTY_FUNCTION), (c.oncomplete = n.EMPTY_FUNCTION), (c.isViewerMode = !0)),
        c.onResize && 'function' == typeof c.onResize && c.onResize !== n.EMPTY_FUNCTION
          ? (c.onResize = c.onResize)
          : c.onresize && 'function' == typeof c.onresize && c.onresize !== n.EMPTY_FUNCTION
          ? (c.onResize = c.onresize)
          : ((c.onResize = n.EMPTY_FUNCTION), (c.onresize = n.EMPTY_FUNCTION)),
        c.onClose && 'function' == typeof c.onClose && c.onClose !== n.EMPTY_FUNCTION
          ? (c.onClose = c.onClose)
          : c.onclose && 'function' == typeof c.onclose && c.onclose !== n.EMPTY_FUNCTION
          ? (c.onClose = c.onclose)
          : ((c.onClose = n.EMPTY_FUNCTION), (c.onclose = n.EMPTY_FUNCTION)),
        c.onSearch && 'function' == typeof c.onSearch && c.onSearch !== n.EMPTY_FUNCTION
          ? (c.onSearch = c.onSearch)
          : c.onsearch && 'function' == typeof c.onsearch && c.onsearch !== n.EMPTY_FUNCTION
          ? (c.onSearch = c.onsearch)
          : ((c.onSearch = n.EMPTY_FUNCTION), (c.onsearch = n.EMPTY_FUNCTION)),
        ...
        isNaN(c.pleaseReadGuide) || 'number' != typeof c.pleaseReadGuide
          ? (c.pleaseReadGuide = 0)
          : ((c.pleaseReadGuide = parseInt(c.pleaseReadGuide, 10)), c.pleaseReadGuide <= 2 && (c.pleaseReadGuide = 0), c.pleaseReadGuide > 20 && (c.pleaseReadGuide = 20)),
        ...
        isNaN(c.maxSuggestItems) || 'number' != typeof c.maxSuggestItems
          ...
          : ((c.maxSuggestItems = parseInt(c.maxSuggestItems, 10)), (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) && (c.maxSuggestItems = 10)),
        (c.windowHeightAvailableForSuggest = 45 * c.maxSuggestItems + 50),
        c.theme)
      ) {
        var f = r.getPreprocessResult(c.theme);
    ...
    var l = (function (a) {
        ...
        return function () {
          return b
            ? !1
            : (alert(
                '[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.',
              ),
              console &&
      ...
      p = a.viewUtils,
      q = a.frame,
      r = a.themePreprocessor,
      s = 'http:' === a.CONT.PROTOCOL ? !1 : !0,
      t = (s ? 'https:' : 'http:') + '//postcode.map.daum.net/search',
      u = encodeURIComponent(n.PROTOCOL + '//' + e.host),
      v = encodeURIComponent(e.pathname),
      w = encodeURIComponent(e.search),
      x = t + '?origin=' + u;
    q.init(x, v, w),
      (j.prototype = {
        open: function (a) {
          if (!l()) {
            var b = m.extend({}, this._opt_);
            (b = f(b, a)), (b = g(b, a)), (b = h(b, a)), (b = i(b, a)), (b = m.extend(b, { viewType: 'popup' })), q.popup.create(b);
          }
        },
        embed: function (a, b) {
          if (!l()) {
            var c = m.extend({}, this._opt_);
            (c = f(c, b)), (c = i(c, b)), (c = m.extend(c, { viewType: 'layer' })), q.layer.create(c, a);
          }
        },
      }),
      (c.daum.Postcode = j);
